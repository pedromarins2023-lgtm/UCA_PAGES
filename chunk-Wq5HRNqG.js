import{C as lg,D as op,O as qm,S as jI,a as Is,b as gC,c as Ls,h as XI,j as tg,k as rl,o as It,p as WD,s as Ku,t as BI,y as g}from"./main-TUNIYC6T.js";function M(o,n){if(o&1&&(Is(0,`a`,2),gC(1,` ← Voltar `),rl(),Is(2,`section`,3)(3,`div`,4),Ls(4,`img`,5),rl(),Is(5,`div`,6)(6,`h1`),gC(7),rl(),Is(8,`p`),gC(9),rl()()()),o&2){let e=XI();WD(4),tg(`src`,e.tema.imagem,op)(`alt`,e.tema.titulo),WD(3),lg(` `,e.tema.titulo,` `),WD(2),lg(` `,e.tema.descricao,` `)}}function C(o,n){o&1&&(Is(0,`section`,1)(1,`h1`),gC(2,` Tema não encontrado `),rl(),Is(3,`a`,2),gC(4,` Voltar para Home `),rl()())}var f=class o{route=g(It);tema=null;temas={manguezal:{titulo:`O que é o Manguezal?`,imagem:`https://guardioesdomar.org.br/wp-content/uploads/2024/03/mulher-projeto-uca-exibi-muda-replantio-manguezal-768x512.jpg`,descricao:`
